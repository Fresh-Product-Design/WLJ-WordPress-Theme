...
<form class="<?php if(array_key_exists("classes", $args) === true) { esc_attr_e($args["classes"]); } ?>" data-js="submitLead" data-lead-capture="fullSansPhone">
  <div class="grid grid-cols-2 grid-rows-6 gap-2 mb-4">
    ...
    <input class="col-span-2 text-[14px] px-4 py-3 border border-[#939E9E] placeholder-[#808080] rounded" type="email" name="email" placeholder="Email" required />
