<div class="bg-white py-8 text-center" data-js="multipleQuotes">
  <div class="content-container bg-white py-16">
    <div class="relative px-4 sm:px-16">
      ...
      <!-- Quotes -->
      <div data-quote>
        <p class="inline-block max-w-[740px] bg-quote-yellow bg-left-top bg-no-repeat mx-6 py-3 mb-2 text-lg">You are so convincing! So warm! The audience loved you.</p>
