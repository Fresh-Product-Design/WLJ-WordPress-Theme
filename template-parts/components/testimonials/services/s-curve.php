<div class="content-container py-24">
  <div class="bg-white py-12 mb-8 text-center rounded md:shadow-behind">
    <p class="inline-block max-w-[1050px] bg-quote-yellow bg-left-top bg-no-repeat mx-6 py-3 mb-3 text-lg">The S Curve of Learning framework has revolutionized how I think about developing my team.</p>
