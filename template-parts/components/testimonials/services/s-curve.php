<div class="content-container py-24">
  <div class="bg-white py-12 mb-8 text-center rounded md:shadow-behind">
    <p class="inline-block max-w-[1050px] bg-quote-yellow bg-left-top bg-no-repeat mx-6 py-3 mb-3 text-lg">The more I listen to Whitney Johnsons work, the more I admire the fact that disruption is the catalyst of change if you allow it to be and from disruption comes opportunity and usually a better outcome, if you approach it the right way.</p>
    <p>- Garry Turner, Company</p>
  </div>
