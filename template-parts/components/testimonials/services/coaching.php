<div class="content-container pb-24">
  <div class="bg-white py-12 mb-8 text-center rounded md:shadow-behind">
    <div class="relative px-4 sm:px-16" data-js="multipleQuotes">
      ...
      <!-- Quotes -->
      <div data-quote>
        <p class="inline-block max-w-[1050px] bg-quote-yellow bg-left-top bg-no-repeat mx-6 py-3 mb-3 text-lg">Disruption Advisors is an incredible asset and growth enabler for our leadership here at Weave. I'm confident working with them will be a multiplier of your many strengths and talents.</p>
        <p class="font-bold">Jeff Lyman</p>
        <hr class="h-[2px] w-[89px] mx-auto my-1 bg-[#F5D22D]" />
        <p>Chief Growth Officer, Weave</p>
      </div>
      <div class="hidden" data-quote>
        <p class="inline-block max-w-[1050px] bg-quote-yellow bg-left-top bg-no-repeat mx-6 py-3 mb-2 text-lg">Hiring Whitney Johnson was one of the smartest investments I've made in my career.</p>
        <p class="font-bold">Katharine Mobley</p>
        <hr class="h-[2px] w-[89px] mx-auto my-1 bg-[#F5D22D]" />
        <p>CMO, First Advantage</p>
      </div>
      <!-- Active Circles -->
