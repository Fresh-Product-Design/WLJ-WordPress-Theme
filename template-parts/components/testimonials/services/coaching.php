<div class="content-container py-24">
  <div class="bg-white py-12 mb-8 text-center rounded md:shadow-behind">
    <p class="inline-block max-w-[740px] bg-quote-yellow bg-left-top bg-no-repeat px-8 py-3 mb-3 text-lg">Disruption Advisors is an incredible asset and growth enabler for our leadership here at Weave. I'm confident working with them will be a multiplier of your many strengths and talents.</p>
