  ...
  <div class="bg-white py-12 text-center rounded md:shadow-behind">
    <div class="relative px-4 sm:px-16" data-js="multipleQuotes">
      ...
      <div data-quote>
        ...
        <hr class="h-[2px] w-[89px] mx-auto mb-1 bg-[#F5D22D]" />
        <p class="font-bold"><?php esc_html_e($lang["testimonials"]["third"]["name"]); ?></p>
      </div>
      <div data-quote>
        ...
        <hr class="h-[2px] w-[89px] mx-auto mb-1 bg-[#F5D22D]" />
        <p class="font-bold"><?php esc_html_e($lang["testimonials"]["fourth"]["name"]); ?></p>
      </div>
      <div data-quote>
        ...
        <hr class="h-[2px] w-[89px] mx-auto mb-1 bg-[#F5D22D]" />
        <p class="font-bold"><?php esc_html_e($lang["testimonials"]["fifth"]["name"]); ?></p>
      </div>
      <div data-quote>
        ...
        <hr class="h-[2px] w-[89px] mx-auto mb-1 bg-[#F5D22D]" />
        <p class="font-bold"><?php esc_html_e($lang["testimonials"]["sixth"]["name"]); ?></p>
      </div>
      <div data-quote>
        <p class="inline-block max-w-[1050px] bg-quote-yellow bg-left-top bg-no-repeat mx-6 py-3 mb-2 text-lg"><?php esc_html_e($lang["testimonials"]["seventh"]["quote"]); ?></p>
        <hr class="h-[2px] w-[89px] mx-auto mb-1 bg-[#F5D22D]" />
        <p class="font-bold"><?php esc_html_e($lang["testimonials"]["seventh"]["name"]); ?></p>
      </div>
      <!-- Active Circles -->
