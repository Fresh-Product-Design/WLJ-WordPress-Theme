<div id="unlockYourPotential" class="bg-header-waves bg-cover bg-bottom mb-16" >
  <div class="content-container pt-12 pb-28 lg:pt-24 lg:pb-48 xl:pt-28 xl:pb-56 text-center uppercase">
    <?php get_template_part( 'template-parts/components/headers/headline', null, array("label" => $args["headline"], "addt-styles" => "mb-10 leading-normal md:leading-normal lg:leading-normal xl:leading-normal")); ?>
