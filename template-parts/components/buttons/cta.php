<button 
  ...
  class="bg-[#C63732] hover:bg-red-700 text-white text-center px-4 py-3 rounded whitespace-nowrap <?php array_key_exists("addt-styles", $args) === true ? esc_html_e($args["addt-styles"]) : "" ?>"
