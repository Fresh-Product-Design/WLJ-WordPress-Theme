...
<div id="speaking" class="relative bg-black sm:bg-speaking bg-right bg-cover bg-no-repeat py-24">
  ...
  <div class="relative content-container xl:text-center z-20">
    ...
    <p class="md:max-w-[370px] lg:max-w-[704px] text-[#F8F8F8] text-lg md:text-xl xl:mx-auto mb-4">Whitney Johnson customizes each keynote, both in-person and virtual, leaving audiences inspired to grow themselves and their organization.</p>
    <?php get_template_part( 'template-parts/components/buttons/cta', null, array("label" => "Invite Whitney to Speak", "js-hook" => "fireContactModal", "contact-reason" => "Speaking", "addt-styles" => "mr-2 mt-4")); ?>
