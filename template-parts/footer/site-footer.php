<footer id="footer" class="w-full bg-white py-10 lg:pt-20" role="contentinfo">
  ...
  ">
    ...
    <div class="text-center lg:text-left">
      <img class="block mb-6 mx-auto lg:mx-0" src="<?php esc_attr_e(get_template_directory_uri() . '/src/assets/images/footerLogo.png') ?>" alt="" width="159" height="37" />
      <div class="flex justify-center lg:justify-start space-x-4">
        <a href="#" target="_blank" rel="noopener"><img src="<?php esc_attr_e(get_template_directory_uri() . '/src/assets/images/twitter.png') ?>" alt="" width="21" height="20" /></a>
        <a href="#" target="_blank" rel="noopener"><img src="<?php esc_attr_e(get_template_directory_uri() . '/src/assets/images/instagram.png') ?>" alt="" width="21" height="20" /></a>
        <a href="#" target="_blank" rel="noopener"><img src="<?php esc_attr_e(get_template_directory_uri() . '/src/assets/images/linkedin.png') ?>" alt="" width="21" height="20" /></a>
      </div>
    </div>
    <!-- Solution Links -->
    <div class="text-center lg:text-left">
  ...
  <p class="text-center space-y-2 md:space-y-0 md:space-x-1 text-sm">
    ...
    <a href="#" class="block md:inline font-semibold text-[#017381] hover:underline">Terms of Use</a>
    <span class="hidden md:inline">|</span>
    <a href="#" class="block md:inline font-semibold text-[#017381] hover:underline">Privacy Policy</a>
  </p>
</footer>