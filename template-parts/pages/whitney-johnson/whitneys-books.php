...
<div id="books" class="bg-white py-24">
  <div class="content-container text-center">
    ...
    <div class="flex flex-col sm:flex-row justify-evenly flex-wrap space-y-4 mb-8">
      ...
      <div class="sm:mt-4">
        <a href="<?php esc_attr_e($LINKS["build-an-a-team"]) ?>" target="_blank" rel="noopener" class="relative group inline-block sm:block border-[2px] border-white hover:border-[#017381] rounded hover:bg-black/10">
      ...
      <div class="sm:mt-4">
        <a href="<?php esc_attr_e($LINKS["dare-dream-do"]) ?>" target="_blank" rel="noopener" class="relative group inline-block sm:block border-[2px] border-white hover:border-[#017381] rounded hover:bg-black/10">
