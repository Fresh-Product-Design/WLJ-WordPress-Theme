...
<div class="pt-24">
  <div class="content-container">
    <?php get_template_part( 'template-parts/components/headers/basic', null, array("label" => $lang["launchPoint"]["title"], "mb" => "mb-2", "align" => "text-left")); ?>
    <p class="text-lg mb-8"><?php esc_html_e($lang["launchPoint"]["text"]); ?></p>
