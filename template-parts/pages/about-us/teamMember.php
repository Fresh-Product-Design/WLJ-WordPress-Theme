<?php
  $teamMemberStyles = "w-[265px] md:w-[170px] lg:w-[220px] xl:w-[265px]";
  // isEmpty Check
  $teamMemberStyles .= array_key_exists("isEmpty", $args) ? " hidden md:block" : "";
?>
<div class="<?php esc_attr_e($teamMemberStyles); ?>">
