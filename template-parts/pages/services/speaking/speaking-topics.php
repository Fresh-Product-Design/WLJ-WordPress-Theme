<div id="speaking-topics" class="content-container pb-24">
  ...
  <?php get_template_part( 'template-parts/components/buttons/hollow-download', null, array('label' => 'View the Speaking Brochure', 'link' => "#", "addt-styles" => "mb-12")); ?>
  <!-- Video Examples -->
    ...
    <div class="flex flex-col md:flex-row border-b border-[#BFBFBF] pb-8 lg:border-none lg:pb-0">
      <div class="mb-8 md:mb-0 md:mr-8 flex-shrink-0">
        <a class="relative block group" href="#">
          <div class="absolute inset-0 z-10 bg-transparent group-hover:bg-black/20"></div>
      ...
      <div class="space-y-4">
        ...
        <a class="group flex items-center font-bold text-[#017381] hover:text-[#143b3f]" href="#">
  ...
  <div class="flex flex-col md:flex-row justify-center text-center pt-6 lg:pt-10">
    ...
    <?php get_template_part( 'template-parts/components/buttons/hollow-download', null, array('label' => "View the Speaking Brochure", 'link' => "#", "addt-styles" => "mt-4")); ?>
  </div>
</div>