<div class="content-container mb-24 text-[#4d4d4d]">
  <?php get_template_part( 'template-parts/components/headers/basic-strikethrough', null, array("label" => "Features of the Platform", "bg-color" => "bg-[#E5E5E5]", "line-color" => "bg-black")); ?>
