<div class="relative">
  <div class="overflow-auto mb-16">
    <div class="flex sm:pl-[200px] md:pl-[328px] lg:pl-0 w-[722px] md:w-[848px] lg:w-auto space-x-2">
      ...
      <div class="w-[200px] md:w-auto sm:absolute lg:static top-0 bottom-0 left-0 sm:shadow-right lg:shadow-none lg:flex-grow flex flex-col space-y-2 text-[#4d4d4d] lg:text-lg">
        ...
        <div class="flex items-center h-[68px] bg-white rounded"><p class="font-semibold px-4 lg:px-6">Galvanizing Growth Mindset Theory</p></div>
        <div class="flex items-center h-[68px] bg-white rounded"><p class="font-semibold px-4 lg:px-6">Growth Culture Driven</p></div>
        <div class="flex items-center h-[68px] bg-white rounded"><p class="font-semibold px-4 lg:px-6">Individual and Group Coaching</p></div>
      </div>
      <!-- Disruption Advisors Column -->
      <div class="flex flex-col w-[166px] space-y-2 lg:text-lg">
        <div class="flex items-center justify-center h-[68px] bg-white rounded"><p class="text-[#017381] font-bold text-center px-5">Disruption Advisors</p></div>
