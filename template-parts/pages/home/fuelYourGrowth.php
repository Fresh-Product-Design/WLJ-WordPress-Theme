...
<div class="content-container text-[#4d4d4d] text-center mb-24">
  ...
  ">
    <div class="mx-auto md:mx-0">
      <img class="mx-auto mb-4" src="<?php esc_attr_e(get_template_directory_uri() . '/src/assets/images/icons/assessment@3x.png') ?>" alt="" width="72" height="87" />
    ...
    <div class="mx-auto md:mx-0">
      <img class="mx-auto mb-4" src="<?php esc_attr_e(get_template_directory_uri() . '/src/assets/images/icons/coaching@3x.png') ?>" alt="" width="90" height="87" />
    ...
    <div class="mx-auto md:mx-0">
      <img class="mx-auto mb-4" src="<?php esc_attr_e(get_template_directory_uri() . '/src/assets/images/icons/certifications@3x.png') ?>" alt="" width="70" height="87" />
    ...
    <div class="mx-auto md:mx-0">
      <img class="mx-auto mb-4" src="<?php esc_attr_e(get_template_directory_uri() . '/src/assets/images/icons/speaking@3x.png') ?>" alt="" width="84.5" height="87" />
